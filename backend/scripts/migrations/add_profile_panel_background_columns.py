"""Add profile_panel_style and profile_background to developer_profile. Run from backend: python add_profile_panel_background_columns.py"""
import os
import sys
import sqlite3
...
for col_name, default in [('profile_panel_style', "'solid'"), ('profile_background', "'default'")]:
